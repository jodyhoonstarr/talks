import{d as _,u as d,a as p,c as m,b as h,e as n,f as t,t as s,g as a,F as u,r as f,n as g,h as v,o as l,i as x,j as b,k as y,l as k,m as N,_ as w}from"./index-9f05b3a3.js";import{N as P}from"./NoteDisplay-05654e0c.js";const V={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=_({__name:"PresenterPrint",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
