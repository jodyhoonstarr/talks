<template>
  <div>
    <div class="absolute inset-0 -z-10 overflow-hidden bg-gray-950 right-[40rem] min-w-full">
      <svg class="absolute -right-40 bottom-auto left-auto top-[-40%] h-[180%] w-[80rem]" aria-hidden="true">
        <defs>
